...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div>
        {/* link does internal routing */}

        <p
          className={`max-w-[30ch] px-8 py-2 mr-4 mb-4 outline outline-offset-2 outline-blue-500 rounded-full absolute bottom-0 right-0`}
          onClick={showModal}
        >
          Quiz babe
        </p>

        {show ? <p>Cheese</p> : <QuizModal />}
      </div>
    </main>
  );
}
